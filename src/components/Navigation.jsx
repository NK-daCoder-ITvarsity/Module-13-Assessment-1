            ...
            <nav className='flex flex-col justify-between h-screen py-6 sticky top-5 border'>
                <section>
                    <a href="#" className="flex flex-col items-center justify-center">
                        <img src="/task-mate.svg" alt="" className="size-12 "/>
                        <p className='text-xl font-bold text-sky-500'>Task Mate</p>
                    </a>
                    <ul className='mt-10 flex flex-col font-semibold'>
                        {
                            softwarePaths.primaryPaths.map((item, index) => (
                                <li key={`primary-button-${index}`}>
                                    ...
                                    >
                                        <span className={`flex items-center justify-center p-2 size-8 rounded ${updatedSection === item.label ? "bg-gradient-to-b from-sky-500 to-blue-500" : ""}`}>
                                            <img 
                ...
                <ul className='flex flex-col font-semibold pb-2 py-1'>
                    {
